	...
	<form role="form" method="post" action=""> <!--всегда добавлять role="form" для bootstrap-->
		<div class="form-group" id="SelectCourses">
			...
			<select class="form-control" id="select_direct">
				<option selected="selected" value="0">Choose the direction of training:</option>
				<option value="13">Bachelor's degree in Economics</option> 
				<option value="14">Master in Electrical and Electrical Engineering (Project Management)</option> 
			</select>
