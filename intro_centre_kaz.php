...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6"style="text-align: right;"><a href="logout.php">Шығу</a> аккаунттан</br><h4><?php echo $_SESSION['NameCompany'];?></h4></div>
	</div>		
</div>		
	...
	<form role="form" method="post" action=""> <!--всегда добавлять role="form" для bootstrap-->
		<div class="form-group" id="SelectCourses">
			...
			<select class="form-control" id="select_direct">
				...
				<option value="9">Энергиямен жабдықтау сараптамасы және энергия тиімділігін арттыру саласындағы оқу орталығы </option> 
				<option value="10">Тілдерді оқыту және аударма орталығы</option> 
				<option value="11">Заманауи бағдарламалау мектебі</option> 
			</select>
