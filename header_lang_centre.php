			...
			<div class="col-md-12 col-sm-12 col-xs-12">
 			<nav role="navigation" class="navbar navbar-default" style="background:#010039;height:76px;font-size:16px;border-color:#010039;">
				<div class="navbar-header">
					<a href="./index.php"><img src="./images/Menu/log_rus.png" class="log" style="width:28%;	margin-top:4px;"></a>
				</div>	
					<ul class="navbar-right" style="margin:10px;">
						<!--a href="index_kz.html"><p style="font-family:fantasy;display:inline-block;font-size:22px;">KZ</p></a-->
						<a href="./index.html"><p style="font-family:fantasy;display:inline-block;font-size:22px;">RU</p></a>
					...
					<div class="container-fluid" style="margin-top: 0px; margin-bottom: 0px;">
						...
						<div class="hsldr-container" style="max-height: 600px;">
							...
							<figure>
								...
								<a href="./centre_of_language.php#angl" class="banner">
								<figcaption>Car in the snow</figcaption>
								</a>
							</figure>
			...
			<!--div id="navbarCollapse" class="collapse navbar-collapse text-center"-->
				...
				<div style="display: inline-block;">
					...
					<ul class="dropdown-menu" style="background:#d11633">
						<li role="presentation"><a role="menuitem" tabindex="-1" href="./index.php#block2">Курсы повышения квалификации</br>и переподготовки специалистов</a></li>
					...
					<li class="dropdown">
						...
						<ul class="dropdown-menu" style="background:#d11633">
							...
							<li role="presentation"><a role="menuitem" tabindex="-1" href="./centre_of_language.php#block8">
