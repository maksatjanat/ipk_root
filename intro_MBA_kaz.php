...
function ajax_search(){ 
  ...
  $.post("./find.php", {select_direct : "8"}, function(data){
   if (data.length>0){ 
...
<div class="row">
	<div id="welcome">	
	<div class="col-lg-6 col-md-6 col-sm-6" style="text-align: left;"><h3>Қощ келдіңіз,</h3><h4><?php echo $_SESSION['fullname'];?>! </h4></div>
