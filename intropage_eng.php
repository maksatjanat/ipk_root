...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6"style="text-align: right;"><a href="logout.php">Exit</a> from account</br><h4><?php if ($_SESSION['b_employee']){echo $_SESSION['NameCompany'];}?></h4></div>
	</div>		
</div>		
	...
	<form role="form" method="post" action=""> <!--всегда добавлять role="form" для bootstrap-->
		<div class="form-group" id="SelectCourses">
			...
			<select class="form-control" id="select_direct">
				...
				<option value="1">Electric stations</option>
				<option value="2">Electricity of the net </option>
				<option value="3">Energy saving </option>
				<option value="4">Ecology</option> 
				<option value="5">Telecommunications </option>
				<option value="6">IT technology</option> 
