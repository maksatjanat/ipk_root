...
<div class="row">
	<div id="welcome">	
	<div class="col-lg-6 col-md-6 col-sm-6" style="text-align: left;"><h3>)Қош келдіңіз,</h3><h4><?php echo $_SESSION['fullname'];?>! </h4></div>
	<div class="col-lg-6 col-md-6 col-sm-6"style="text-align: right;"><a href="logout.php">Шығу</a> аккаунтан</br><h4><?php if ($_SESSION['b_employee']){echo $_SESSION['NameCompany'];}?></h4></div>
	</div>		
</div>		
	...
	<form role="form" method="post" action=""> <!--всегда добавлять role="form" для bootstrap-->
		<div class="form-group" id="SelectCourses">
			...
			<select class="form-control" id="select_direct">
				<option selected="selected" value="0">Біліктілікті арттыру курстарының бағытын таңдаңыз:</option>
				<option value="1">Электр стансалары</option>
				<option value="2">Электр желілері  </option>
				<option value="3">Энергиямен жабдықтау </option>
				<option value="4">Экология</option> 
				<option value="5">Телекоммуникациялар </option>
				<option value="6">ИТ-технологиялар</option> 
				<option value="7">Автоматтандыру</option> 
			</select>
