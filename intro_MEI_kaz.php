...
<div class="row">
	...
	<div class="col-lg-6 col-md-6 col-sm-6"style="text-align: right;"><a href="logout.php">Шығу</a> аккаунтан</br><h4><?php echo $_SESSION['NameCompany'];?></h4></div>
	</div>		
</div>		
	...
	<form role="form" method="post" action=""> <!--всегда добавлять role="form" для bootstrap-->
		<div class="form-group" id="SelectCourses">
			...
			<select class="form-control" id="select_direct">
				<option selected="selected" value="0">Оқыту бағытын таңдаңыз:</option>
				<option value="13">"Экономика бағыты бойынша бакалавриат</option> 
				<option value="14">Магистратура "Электр энергетикасы мен  электртехникасы" (Жобаларды басқару)</option> 
			</select>
